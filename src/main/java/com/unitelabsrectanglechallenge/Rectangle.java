...
class Rectangle {
    ...
    static RectangleFromIntersection calculateIntersection(Rectangle rectangle1, Rectangle rectangle2) {
        LinkedList<Vector2D> cornerPointsIntersectingThis = rectangle2.getIntersectingCornerPoints(rectangle1);
        if (cornerPointsIntersectingThis.size() == 4) {
            return new RectangleFromIntersection(rectangle1.origin, rectangle1.width, rectangle1.height, rectangle2, rectangle1);
        }

        LinkedList<Vector2D> cornerPointsIntersectingOther = rectangle1.getIntersectingCornerPoints(rectangle2);
        if (cornerPointsIntersectingOther.size() == 4) {
