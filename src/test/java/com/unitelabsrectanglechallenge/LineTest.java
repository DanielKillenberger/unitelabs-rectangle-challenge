...
class LineTest {
    ...
    @Test
    void CalculateIntersection_When_LinesNotParallelToAxis_Expect_InvalidParameterException() {
        Line line1 = new Line(origin, new Vector2D(1, 1));
        Line line2 = new Line(origin, new Vector2D(0, 1));
        assertThrows(InvalidParameterException.class, () -> Line.calculateIntersection(line1, line2));
        assertThrows(InvalidParameterException.class, () -> Line.calculateIntersection(line2, line1));
        assertThrows(InvalidParameterException.class, () -> Line.calculateIntersection(line1, line1));
    }
    ...
    void IsPointOnLine_When_PointOnLine_Expect_0() {
        ...
        assertEquals(0, line.whereIsPointRelativeToLine(origin));
        assertEquals(0, line.whereIsPointRelativeToLine(new Vector2D(1, 1)));
